...
const Physio = () => {
  return (
    <main className="physio-about-container">
      <header className="physio-about-header">
        <nav>
          <Navbar />
        </nav>
      ...
      <section className="physio-about-main-section">
        <p>
          ...
          injuries, osteoarthritis, and other health related conditions. MVP
          works alongside Vets to accurately find issues/weaknesses that your
          pet has to design the most effective treatment plan that will return
