      ...
      <Navbar />
        ...
        <p>
          Veterinary Physiotherapy is the assessment and treatment of
           ...
           musculoskeletal conditions and injuries, osteoarthritis, and
           other health related conditions. MVP works alongside Vets to
           accurately find issues/weaknesses that your pet has to design
           the most effective treatment plan that will return them to normal
           function.
        </p>
        <img className="side-image" alt="Rider on horseback looking away" src="https://imagestoragemvp.s3.eu-west-2.amazonaws.com/SJ-pony.jpeg"></img>
        <img className="side-image" alt="back of a saddle" src="https://imagestoragemvp.s3.eu-west-2.amazonaws.com/saddle-back.jpeg"></img>
        <p>
          ...
          exercise plan to further address all issues and meet the individual’s
          needs. The main aim is always to improve an animal’s health and
          wellbeing by reducing pain, limiting injury impact, promoting
          healing to accelerate the return to normal function and to improve
        ...
        <p>
          ...
          recovery. MVP also works with animal athletes to reduce injury
          risk whilst enhancing performance to benefit competing or working
        ...
        <img className="side-image" alt="Rider behind a jump" src="https://imagestoragemvp.s3.eu-west-2.amazonaws.com/arena-riding.jpeg"></img>
